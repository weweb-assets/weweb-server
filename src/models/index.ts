...
import * as pageMetadata from './pageMetadata.model'
...
export type models = {
    ...
    pageMetadata: pageMetadata.PageMetadataStatic
}

export { page, redirection, designVersion, pluginSettings, cmsDataSet, design, pageMetadata }
